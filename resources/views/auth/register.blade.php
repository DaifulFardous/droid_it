...
<head>
    ...
    <link
        href="{{ asset('/backend')}}/vendor/fonts/fonts.css"
        rel="stylesheet">
                        ...
                        <form class="user" action="{{ route('register') }}" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-6 mb-sm-0">
                                    <input type="text" id="exampleFirstName"
                                           placeholder="Name" class="form-control form-control-user
                            ...
                            <div class="form-group">
                                <input type="email" id="exampleInputEmail"
                                       placeholder="Email Address" class="form-control form-control-user
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input id="exampleInputPassword" placeholder="Password" type="password" class="form-control form-control-user
